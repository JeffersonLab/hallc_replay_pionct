...
std::vector<double> hQ2_range{200,0.1,10},hx_range{200,0.01,1.2},hW_range{200,0.1,5},hz_range{200,0.01,1.2},hMMpi_range{200,-0.5,14};
// ---
...
// Main function
int get_coin_ev_test(int rnum,                 // Run number to analyze
         ...
         TString QVal = "5")  // Q2 value for simc plot (8.5, 7.5, 6.5, 5)
{
		       ...
		       double ppx, double ppy, double ppz, double pp)
  {
    ...
    ROOT::Math::PxPyPzEVector Pp(0, 0, 0, MA);
